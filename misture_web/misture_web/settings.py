# coding=utf-8
"""
Django settings for misture_web project.
...
INSTALLED_APPS = [
    'examen.apps.ExamenConfig',  # Aplicación de examenes
...
WSGI_APPLICATION = 'misture_web.wsgi.application'
